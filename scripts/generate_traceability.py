...
SECTION_MAP: dict[int, tuple[str, str, str]] = {
    ...
    29: ("DETERMINISTIC_AND_PLATFORM", "toolkit/ztad/bug_protocol.py; toolkit/ztad/evidence_bundle.py; toolkit/ztad/host_acceptance.py; toolkit/ztad/capabilities.py; toolkit/ztad/orchestrator.py; toolkit/ztad/scheduler.py; scripts/generate_release_evidence.py; scripts/verify_release_evidence.py; policies/bug-to-production-policy.yaml; policies/state-machine.yaml; schemas/evidence-bundle.schema.json; schemas/release-evidence.schema.json; .github/workflows/release.yml; tests/test_v439_fail_closed_protocol.py; tests/test_v439_release_evidence.py; evals/protocol-adversarial-cases.json", "protocol gate, artifact-chain, host-boundary, scheduler-boundary, release-evidence, and adversarial evaluation tests"),
    30: ("DETERMINISTIC_AND_PLATFORM", "toolkit/ztad/subject.py; toolkit/ztad/bug_lifecycle.py; toolkit/ztad/evidence.py; toolkit/ztad/approval_controller.py; schemas/evidence.schema.json; schemas/bug-lifecycle.schema.json", "subject mutation, stale-evidence, approval invalidation, and PR-to-main adversarial tests"),
    31: ("PROTECTED_CONTROLLER", "toolkit/ztad/lifecycle_store.py; toolkit/ztad/bug_lifecycle.py; scripts/ztad_bug_lifecycle.py; schemas/bug-lifecycle.schema.json", "ledger hash-chain, sequence, actor, no-code, tamper, and stale-write tests"),
    32: ("DETERMINISTIC_AND_PLATFORM", "toolkit/ztad/risk.py; toolkit/ztad/bug_protocol.py; toolkit/ztad/evidence.py; toolkit/ztad/evidence_bundle.py; policies/bug-to-production-policy.yaml", "risk monotonicity, full-domain union, provenance, trust, and progressive-exposure adversarial tests"),
    33: ("DETERMINISTIC_AND_PLATFORM", "toolkit/ztad/evidence_bundle.py; toolkit/ztad/bug_protocol.py; toolkit/ztad/bug_lifecycle.py; schemas/evidence-bundle.schema.json; policies/bug-to-production-policy.yaml", "no-code bundle replay, rollback-domain, incident, migration-sequence, and performance-evidence tests"),
}
